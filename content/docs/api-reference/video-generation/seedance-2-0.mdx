---
title: 'Seedance 2.0'
description: 'Documentation and details for Seedance 2.0'
---

# Seedance 2.0

A specialized video generation model focused on high-energy motion, choreography, and dynamic framing.

## Overview

Seedance 2.0 represents the cutting edge of generative AI. Whether you are building production-level applications or rapid prototypes, this model provides the reliability, quality, and speed necessary for modern AI workflows.
