...
description: 'Documentation and details for Runway Gen-4 Image'
---

# Runway Gen-4 Image

Runway's state-of-the-art foundational image model, designed for cinematic aesthetics, hyper-realism, and unparalleled artistic control.

## Overview

Runway Gen-4 Image represents the cutting edge of generative AI. Whether you are building production-level applications or rapid prototypes, this model provides the reliability, quality, and speed necessary for modern AI workflows.
