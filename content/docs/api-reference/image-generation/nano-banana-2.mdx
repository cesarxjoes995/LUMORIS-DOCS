---
title: 'Nano Banana 2'
description: 'Documentation and details for Nano Banana 2'
---

# Nano Banana 2

An upgraded Flash model offering higher resolutions up to 4K while maintaining blazing-fast generation speeds.

## Overview

Nano Banana 2 represents the cutting edge of generative AI. Whether you are building production-level applications or rapid prototypes, this model provides the reliability, quality, and speed necessary for modern AI workflows.
