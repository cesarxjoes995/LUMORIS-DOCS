...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex bg-black selection:bg-zinc-800 font-sans">
      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-12 lg:px-24 bg-black relative">
          ...
          <div className="mt-8 mb-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-black text-zinc-500 font-medium">Or continue with email</span>
              </div>
            </div>
          </div>
